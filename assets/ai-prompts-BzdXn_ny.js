import{u as a,j as e}from"./index-CEWbc2Vr.js";function t(o){const n={code:"code",h2:"h2",h3:"h3",hr:"hr",pre:"pre",...a(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Introduction"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`As a Fullstack Typescript/NodeJs Developer and Solution engineer, strong in NodeJS, ReactJS, MongoDB, PostgreSQL, AWS.
`})}),`
`,e.jsx(n.h2,{children:"Freelancer"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`As a Freelancer full-stack Typescript/NodeJS Developer and Solution engineer working on Upwork. I would like you to write me a cover letter to win the job, and I plan to deliver high-quality work.

Cover letter:
- For the developer and client to understand, because almost Upwork's clients of mine know technical.
- Don't use Markdown format - Use text format.
- Maximum 1250 characters, to copy/paste to the form.
- Some example respectful and friendly words, use a similar format when you write a cover letter:
  - "There are some fields I don't understand. I hope that we can work and discuss them together."
  - "Your task description is clear, especially the detailed backend (or frontend) architecture. I want to describe a clear frontend (or backend) side."
  - "I have experience in security applications, to solve and get a Pen-test certification from a Swiss company."
  - CTA: "Looking forward to hearing from you soon!"
  - CTA: "If you want to collaborate, let’s discuss more over the chat!"
  - CTA: "I would appreciate scheduling a quick call with you and further discussing about the project"
- Task list and detailed to-do in the FIRST WEEK (about 12h estimation, show the client the onboarding process)
...
`})})]})}function s(o={}){const{wrapper:n}={...a(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{s as default};
