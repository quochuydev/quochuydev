...
`]}),`
`,e.jsx(n.hr,{}),`
`,e.jsxs(n.h2,{id:"-solution-outline",children:["🧩 Solution Outline",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#-solution-outline",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`]}),`
`,e.jsx(n.hr,{}),`
`,e.jsxs(n.h2,{id:"-simple-architecture-diagram-text-based",children:["🔄 Simple Architecture Diagram (Text-Based)",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#-simple-architecture-diagram-text-based",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(n.p,{children:`User
│
▼
...
`,e.jsx(n.hr,{}),`
`,e.jsxs(n.h2,{id:"-what-youll-get",children:["✅ What You’ll Get",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#-what-youll-get",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(n.ul,{children:[`
...
`]}),`
`,e.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:e.jsxs(n.code,{children:[e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"Hi [Client],"})}),`
...
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"If you're posting on GitHub, use this format:"})})]})}),`
`,e.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:e.jsxs(n.code,{children:[e.jsx(n.span,{className:"line",children:e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"<details><summary>Mermaid Example</summary>"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"graph TD"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"  A[User Input] --> B[Node.js Backend]"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"  B --> C[OpenAI API]"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"  B --> D[Email Service]"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"  B --> E[PostgreSQL]"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"</details>"})})]})})]})}function d(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{d as default,a as frontmatter};
