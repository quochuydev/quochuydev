...
Create a markdown file in `docs/devto/<repo-name>.md` with this exact format:
...
Save the blog to `docs/devto/<repo-name>.md` using the repository name (e.g., `workflow.md` for `quochuydev/workflow`).

## Example Reference

See `docs/devto/workflow.md` for the target format and style.
