...
2. **Document Structure**
   Create a markdown file in `ai/<topic>-overview.md` with:
...
5. **Output**
   - Save the document to `ai/<topic-slug>-overview.md`
   - Use kebab-case for the filename (e.g., `binance-smart-chain-overview.md`)

## Example Reference

See existing files in `ai/` directory for format examples:
- `ai/bitcoin-overview.md` - Cryptocurrency technical overview
- `ai/loveable-overview.md` - Platform architecture and how to build similar
