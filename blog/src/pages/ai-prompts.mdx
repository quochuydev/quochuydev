...
```
As a Fullstack Typescript/NodeJs Developer and Solution engineer, strong in NodeJS, ReactJS, MongoDB, PostgreSQL, AWS.
```

## Freelancer

```
As a Freelancer full-stack Typescript/NodeJS Developer and Solution engineer working on Upwork. I would like you to write me a cover letter to win the job, and I plan to deliver high-quality work.
