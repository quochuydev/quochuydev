...
![alt](../public/lemonldap/1.png)

`General Parameters > Issuer modules > SAML > Activation: On`

![alt](../public/lemonldap/2.png)
...
docker restart zitadel_container_name
```
