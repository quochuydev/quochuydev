...
![authentication.drawio.png](authentication.drawio.png)
...
2. **OpenID Connect Endpoints in ZITADEL**: [https://zitadel.com/docs/apis/openidoauth/endpoints](https://zitadel.com/docs/apis/openidoauth/endpoints)

3. **PKCE - Recommendation for authorization flow**: [https://zitadel.com/docs/guides/integrate/login/oidc/oauth-recommended-flows#our-recommended-authorization-flows](https://zitadel.com/docs/guides/integrate/login/oidc/oauth-recommended-flows#our-recommended-authorization-flows)